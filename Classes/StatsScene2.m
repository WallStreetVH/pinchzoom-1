		...
		if(sqlite3_open([databasePath UTF8String], &database) == SQLITE_OK) {
			...
			if(sqlite3_prepare_v2(database, sqlStatement2, -1, &compiledStatement, NULL) == SQLITE_OK) {
					...
					
				{
					...
					if([animal.nameit2 isEqualToString:@"E4"]){
						NSString *str1 = [[NSString alloc] initWithFormat:@"E4X:%@ E4Y:%@ U:%@", animal.tileLocX, animal.tileLocY, animal.used];
					...
					if([animal.nameit2 isEqualToString:@"E5"]){
						NSString *str2 = [[NSString alloc] initWithFormat:@"E5X:%@ E5Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
					...
					if([animal.nameit2 isEqualToString:@"E6"]){
						NSString *str3 = [[NSString alloc] initWithFormat:@"E6X:%@ E6Y:%@ U:%@",animal.tileLocX, animal.tileLocY,animal.used];
					...
					if([animal.nameit2 isEqualToString:@"E7"]){
						NSString *str4 = [[NSString alloc] initWithFormat:@"E7X:%@ E7Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
					...
					if([animal.nameit2 isEqualToString:@"E8"]){	 
						NSString *str5 = [[NSString alloc] initWithFormat:@"E8X:%@ E8Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
						[labelLoc46 setString:str5];
						[str5 release];
						labelLoc46.position = ccp(5,370);
						[self addChild:labelLoc46 z:2];
					}
					if([animal.nameit2 isEqualToString:@"E9"]){	 
						NSString *str6 = [[NSString alloc] initWithFormat:@"E9X:%@ E9Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
						[labelLoc47 setString:str6];
						[str6 release];
						labelLoc47.position = ccp(5,360);
						[self addChild:labelLoc47 z:2];
					}
					if([animal.nameit2 isEqualToString:@"E10"]){	 
						NSString *str7 = [[NSString alloc] initWithFormat:@"E10X:%@ E10Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
						[labelLoc48 setString:str7];
						[str7 release];
						labelLoc48.position = ccp(5,350);
						[self addChild:labelLoc48 z:2];
					}
					if([animal.nameit2 isEqualToString:@"E11"]){	 
						NSString *str8 = [[NSString alloc] initWithFormat:@"E11X:%@ E11Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
						[labelLoc49 setString:str8];
						[str8 release];
						labelLoc49.position = ccp(5,340);
						[self addChild:labelLoc49 z:2];
					}
					if([animal.nameit2 isEqualToString:@"E12"]){	 
						NSString *str9 = [[NSString alloc] initWithFormat:@"E12X:%@ E12Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
						[labelLoc50 setString:str9];
						[str9 release];
						labelLoc50.position = ccp(5,330);
						[self addChild:labelLoc50 z:2];
					}
					if([animal.nameit2 isEqualToString:@"F2"]){	 
						NSString *str10 = [[NSString alloc] initWithFormat:@"F2X:%@ F2Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
						[labelLoc51 setString:str10];
						[str10 release];
						labelLoc51.position = ccp(5,320);
						[self addChild:labelLoc51 z:2];
					}
					if([animal.nameit2 isEqualToString:@"G2"]){	 
						NSString *str11 = [[NSString alloc] initWithFormat:@"G2X:%@ G2Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
						[labelLoc52 setString:str11];
						[str11 release];
						labelLoc52.position = ccp(5,310);
						[self addChild:labelLoc52 z:2];
					}
					if([animal.nameit2 isEqualToString:@"G3"]){	 
						NSString *str12 = [[NSString alloc] initWithFormat:@"G3X:%@ G3Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
						[labelLoc53 setString:str12];
						[str12 release];
						labelLoc53.position = ccp(5,300);
						[self addChild:labelLoc53 z:2];
					}
					if([animal.nameit2 isEqualToString:@"H2"]){	 
						NSString *str13 = [[NSString alloc] initWithFormat:@"H2X:%@ H2Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
						[labelLoc54 setString:str13];
						[str13 release];
						labelLoc54.position = ccp(5,290);
						[self addChild:labelLoc54 z:2];
					}
					if([animal.nameit2 isEqualToString:@"I2"]){	 
						NSString *str14 = [[NSString alloc] initWithFormat:@"I2X:%@ I2Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
						[labelLoc55 setString:str14];
						[str14 release];
						labelLoc55.position = ccp(5,280);
						[self addChild:labelLoc55 z:2];
					}
					if([animal.nameit2 isEqualToString:@"I3"]){	 
						NSString *str15 = [[NSString alloc] initWithFormat:@"I3X:%@ I3Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
						[labelLoc56 setString:str15];
						[str15 release];
						labelLoc56.position = ccp(5,270);
						[self addChild:labelLoc56 z:2];
					}
					if([animal.nameit2 isEqualToString:@"I4"]){	 
						NSString *str16 = [[NSString alloc] initWithFormat:@"I4X:%@ I4Y:%@ U:%@",animal.tileLocX, animal.tileLocY, animal.used];
			...
			NSString *str100 = [[NSString alloc] initWithFormat:@"PAGE 2"];
...
//	[m._gameHUDLayer removeChild:[self myGameHUD] cleanup:YES];
	...
	if ((pos2.x > 280) & (pos2.x < 405) & (pos2.y > 305) & (pos2.y < 349)) {
